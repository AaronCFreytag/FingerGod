...
public class RotatingCubeComponent : Component {
    ...
    open override func create() {
        do {
            ...
            modelInst.transform = GLKMatrix4Translate(modelInst.transform, 0, 3, 0)
    ...
    open override func update(delta:Float) {
        modelInst.transform = GLKMatrix4Rotate(modelInst.transform, Float.pi * delta / 2, 0.7, 0.3, 0.0)
    }
}
